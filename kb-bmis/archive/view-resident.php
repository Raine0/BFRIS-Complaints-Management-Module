...
if (filter_has_var(INPUT_GET, 'resident_archive_id')) {
    $sanitize_id = filter_var($_GET['resident_archive_id'], FILTER_SANITIZE_NUMBER_INT);
    $archive_id = filter_var($sanitize_id, FILTER_VALIDATE_INT);
}

$residentQuery = "SELECT * FROM resident_archive WHERE resident_archive_id = :archive_id";
$residentStatement = $pdo->prepare($residentQuery);
$residentStatement->bindParam(':archive_id', $archive_id, PDO::PARAM_INT);
...
?>
        ...
        <div class="content">
            <div class="card">
                ...
                <div class="info">
                    ...
                    <p><?php echo $resident['archived_by']; ?></p>
                    <h4><strong>Date Archived:</strong></h4>
                    <p><?php echo date('m-d-Y h:i:s a ', strtotime($resident['date_archived'])); ?></p>
                    <h4><strong>Remarks :</strong></h4>
                    <p><?php echo $resident['remarks']; ?></p>
                </div>
                ...
                <div class="card__body">
                    <div class="card__body-content">
                        ...
                        <div class="row">
                            <a class="button button--primary button--sm modal-trigger" data-modal-id="modal-restore">
                        ...
                        <div class="profile-info__content basicInfoTab" style="display: block;">
                            ...
                            <section class="profile-info__basic-info">
                                ...
                                <div class="profile-info__container">
                                    <div class="input__wrapper">
                                        <label for="date_of_birth">Date of Birth <small style="font-style: italic"> (DD - MM - YYYY) </small></label>
                                        <div class="input__inner">
                        ...
                        <div class="profile-info__content votingTab" id="votingTabContent">
    ...
    <div class="modal__wrapper" id="modal-delete">
        <section class="modal__window modal__window--md">
            ...
            <div class="modal__body">
                <p> Are you sure you want to permanently delete <strong><?php echo $resident["first_name"]; ?>
            ...
            <footer class="modal__footer">
                <a href="controllers/resident-delete.php?residents_archive_id=<?php echo $resident["residents_archive_id"]; ?>" class="button button--danger button--md">Delete</a>
    ...
    <?php require "modal/resident-restore-modal.php"; ?>
