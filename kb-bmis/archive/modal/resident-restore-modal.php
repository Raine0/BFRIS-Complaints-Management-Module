<div class="modal__wrapper" id="modal-restore">
    <section class="modal__window modal__window--md">
        ...
        <div class="modal__body">
            ...
            <form action="controllers/resident-restore.php" method="POST">
                    ...
                    <div class="profile-info__container">
                        <div class="input__wrapper">
                            ...
                            <div class="input__inner--with-leading-icon input__inner">
                                ...
                                <input name="password" type="password" id="password" class="input--light300 input--login" value="" style="width: 100%;" required>
                ...
                <input type="text" hidden name="resident_archive_id" value="<?php echo $resident['resident_archive_id']; ?>">
