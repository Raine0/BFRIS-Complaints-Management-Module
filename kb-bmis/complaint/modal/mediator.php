<div class="modal__wrapper" id="modal-mediator">
            ...
            <table id="mediator-table-modal" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a class="select-mediator" data-mediator-id="<?php echo $official['official_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a class="button button--primary button--sm action__cert select-mediator" data-mediator-id="<?php echo $official['official_id'] ?>">
                                        SELECT MEDIATOR
                                    </a>
                                </div>
                            </td>
