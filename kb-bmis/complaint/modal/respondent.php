<div class="modal__wrapper" id="modal-respondent">
            ...
            <table id="respondent-table-modal" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="#" class="select-respondent" data-respondent-id="<?php echo $resident['resident_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a class="button button--primary button--sm action__cert select-respondent" data-respondent-id="<?php echo $resident['resident_id'] ?>">
                                        SELECT RESPONDENT
                                    </a>
                                </div>
                            </td>
