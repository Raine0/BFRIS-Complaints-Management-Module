<div class="modal__wrapper" id="modal-update-complainant">
            ...
            <table id="modal-table" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="#" class="update-complainant" data-complainant-id="<?php echo $resident['resident_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a class="button button--primary button--sm action__cert update-complainant" data-complainant-id="<?php echo $resident['resident_id'] ?>">
                                        SELECT COMPLAINANT
                                    </a>
                                </div>
                            </td>
