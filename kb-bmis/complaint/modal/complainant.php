<div class="modal__wrapper" id="modal-complainant">
            ...
            <table id="modal-table" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="#" class="select-complainant" data-complainant-id="<?php echo $resident['resident_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a class="button button--primary button--sm action__cert select-complainant" data-complainant-id="<?php echo $resident['resident_id'] ?>">
                                        SELECT COMPLAINANT
                                    </a>
                                </div>
                            </td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <a href="../residents/create-resident.php" style="color:#ef6a61">
                            <u>Create Resident Profile Here!</u>
                        </a>
                    </td>
                </tr>
            </table>
