...
if (filter_has_var(INPUT_GET, 'case_no')) {
    ...
    if (!$complaintCount === 1) {
        ...
        header("location: ./../non-resident-complaint-list.php");
        exit();
    }
                            ...
                            <div class="card__body-content">
                                ...
                                <div class="row">
                                    <?php if ($user_role === 'Administrator' || $user_role === 'Barangay Secretary' || $user_role === 'Barangay Clerk - Complaint Admin' || $user_role === 'Barangay Clerk - Complaint Encoder') : ?>
                                        <a href="./non-resident-complaint-update.php?case_no=<?php echo $complaint["case_no"]; ?>" class="button button--primary button--sm">
