...
$page = 'Complaints';
$headerTitle = 'Resident Complaints';
    ...
    <div class="content">
        <section class="brgy-officials">
            ...
            <table id="table" class="row-border">
                        ...
                        <th>
                            <div class="residents__header-actions">
                                ...
                                <?php if ($user_role == 'Barangay Clerk - Complaint Admin' || $user_role == 'Barangay Clerk - Complaint Encoder' || $user_role == 'Barangay Secretary' || $user_role == 'Administrator') : ?>
                                    <button class="button button--primary button--md certificates__button modal-trigger" data-modal-id="modal-complainant" id="add-complaint">
                                        <i class='bx bx-plus' data-modal-id="modal-complainant"></i>
                                        <p data-modal-id="modal-complainant">ADD NEW</p>
                                    </button>
                                <?php endif; ?>
                ...
                <tbody>
                    <?php
                    $complaintQuery = "SELECT case_no, respondent_name, respondent_image FROM resident_complaint_view ORDER BY case_no DESC";
                    ...
                    ?>
                        <tr>
                            <td>
                                <a <?php if ($user_role === 'Administrator' || $user_role === 'Barangay Chairman' || $user_role === 'Barangay Secretary' || $user_role === 'Barangay Clerk - Complaint Admin' || $user_role === 'Barangay Clerk - Complaint Encoder') : ?> href="resident-complaint-view.php?case_no=<?php echo $complaint['case_no'] ?> <?php endif; ?>">
                                ...
                                <a <?php if ($user_role === 'Administrator' || $user_role === 'Barangay Chairman' || $user_role === 'Barangay Secretary' || $user_role === 'Barangay Clerk - Complaint Admin' || $user_role === 'Barangay Clerk - Complaint Encoder') : ?> href="resident-complaint-view.php?case_no=<?php echo $complaint['case_no'] ?>" <?php endif; ?>>
                                    <div class="table__row-text">
                                        <div class="table__row-name">
                                            Respondent: <?php echo $complaint['respondent_name'] ?>
                                        </div>
                            ...
                            <td>
                                ...
                                <div class="table__action-buttons">
                                    <?php if ($user_role === 'Administrator' || $user_role === 'Barangay Chairman' || $user_role === 'Barangay Secretary' || $user_role === 'Barangay Clerk - Complaint Admin' || $user_role === 'Barangay Clerk - Complaint Encoder') : ?>
                                        <a href="./resident-complaint-view.php?case_no=<?php echo $complaint['case_no'] ?>" class="button button--green button--sm action__view" id="action-view">
                                    ...
                                    <?php if ($user_role === 'Administrator' || $user_role === 'Barangay Secretary' || $user_role === 'Barangay Clerk - Complaint Admin' || $user_role === 'Barangay Clerk - Complaint Encoder') : ?>
                                        <a href="./resident-complaint-update.php?case_no=<?php echo $complaint["case_no"]; ?>" class="button button--primary button--sm modal-trigger">
