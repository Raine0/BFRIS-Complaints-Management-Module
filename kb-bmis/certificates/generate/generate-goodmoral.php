...
?>
    ...
    <body>
        <form action="../save/save-goodmoral.php" method="post">
            ...
            <div class="certificate__canvas">
                ...
                <div class="certificate__text certificate__text--brgyclearance">
                    <div>
                        ...
                        <p class="indent">
                            This is to certify that <b><u><?php echo $first_name . " " .  $mid_name . " " . $last_name . $suffix ?>,</u></b> of legal age, <?php echo $nationality ?>, <?php echo $civil_status; ?> and a resident of <b><?php echo $address ?>.</b>
                        </p>
                        ...
                        <p class="indent">
                            This certification is issued upon the request of the above-named person in connection of her requirements for <b><?php echo strtoupper($purpose) ?></b>.
                        </p>
