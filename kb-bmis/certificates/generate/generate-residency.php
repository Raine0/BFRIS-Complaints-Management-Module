...
if (filter_has_var(INPUT_POST, 'resident_id')) {
...
?>
    ...
    <body>
        <form action="../save/save-residency.php" method="post">
            ...
            <div class="certificate__canvas">
                ...
                <div class="certificate__text certificate__text--brgyclearance">
                    <div>
                        ...
                        <p class="indent">
                            This is to certify that <b><u><?php echo $first_name . " " .  $mid_name . " " . $last_name . $suffix ?>,</u></b> of legal age, <?php echo $nationality ?>, <?php echo $civil_status; ?> and a resident of <b><?php echo $address ?> </b> since <b><?php echo $formatted_date_of_residency ?></b> up to present.
                        </p>
                        ...
                        <p class="indent">
                            This certification is issued upon the request of the above-named person, purposively to vouch the fact that he/she is a resident of this community and to comply for <b><u><?php echo strtoupper($purpose) ?></u></b>.
                        </p>
