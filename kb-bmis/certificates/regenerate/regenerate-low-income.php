...
$lowIncomeQuery = "SELECT * FROM low_income_certificate_view WHERE low_income_id = :low_income_id";
...
$clearance_date_issued = $lowIncome['date_issued'];
...
<head>
    ...
    <title>Generated Low Income Certificate - Barangay Information System</title>
</head>
        ...
        <div class="certificate__text certificate__text--brgyclearance">
            <div>
                <div class="row row--space-between">
                    ...
                    <div class="certificate__img">
                        <img src="../../residents/images/<?php echo $plowIncome['resident_image'] ?>" alt="" />
                    </div>
                </div>
                <p class="indent">
                    This is to certify that <b><u><?php echo strtoupper($lowIncome['resident_name']) ?>,</u></b> of legal age, <?php echo $lowIncome['nationality'] ?: 'Filipino' ?>, <?php echo strtolower($lowIncome['civil_status']) ?> and a resident of <b><?php echo $lowIncome['address'] ?>, Barangay Fatima, General Santos City </b> since <b><u><?php echo $formatted_date_of_residency ?></u></b> up to present.
                </p>

                <span class="br br--sm"></span>
                <p class="indent">
                    This is to certify further that the aforementioned person is below <b>Thirty-Six Thousand Pesos (P36, 000)</b> per annum as per declaration of the said person.
                </p>

                <span class="br br--sm"></span>

                <p class="indent">
                    This certification is issued upon the request of the above-named person, purposively to vouch the fact that he/she is a resident of this community and to comply the requirement of <b><u>EX:his/her daughter</u></b> for <b><u><?php echo strtoupper($lowIncome['purpose']) ?></u></b>.
                </p>
                ...
                <div class="row row--flex-start">
                    <div class="certificate__resident">
                        ...
                        <div><b><u><?php echo strtoupper($lowIncome['resident_name']) ?></u></b></div>
            ...
            <div class="row row--flex-end">
                <div class="certificate__official">
                    ...
                    $officialStatement->bindParam(':official_id', $lowIncome['official_id'], PDO::PARAM_INT);
