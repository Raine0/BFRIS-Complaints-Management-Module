...
<div class="modal__wrapper" id="modal-goodmoral">
            ...
            <table id="modal-table" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="good-moral-create.php?resident_id=<?php echo $resident['resident_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a href="good-moral-create.php?resident_id=<?php echo $resident['resident_id'] ?>" class="button button--primary button--sm action__cert" id="action-cert">
                                        SELECT RESIDENT
                                    </a>
                                </div>
                            </td>
