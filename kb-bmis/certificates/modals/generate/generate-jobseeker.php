<!-- GENERATE GOOD MORAL CERTIFICATE MODAL -->

<div class="modal__wrapper" id="modal-jobseeker">
    <section class="modal__window modal__window--md">
        <header class="modal__header">
            <h3>Jobseeker Certificate</h3>
            ...
            <table id="modal-table" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="jobseeker-create.php?resident_id=<?php echo $resident['resident_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a href="jobseeker-create.php?resident_id=<?php echo $resident['resident_id'] ?>" class="button button--primary button--sm action__cert" id="action-cert">
                                        SELECT RESIDENT
                                    </a>
                                </div>
                            </td>
