<!-- GENERATE RESIDENCY 1 CERTIFICATE MODAL -->

<div class="modal__wrapper" id="modal-residency">
            ...
            <table id="modal-table" class="row-border">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="residency-create.php?resident_id=<?php echo $resident['resident_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a href="residency-create.php?resident_id=<?php echo $resident['resident_id'] ?>" class="button button--primary button--sm action__cert" id="action-cert">
                                        SELECT RESIDENT
                                    </a>
                                </div>
                            </td>
