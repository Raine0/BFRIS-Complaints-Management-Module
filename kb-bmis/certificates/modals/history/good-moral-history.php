    ...
    <div class="modal__body">
      <table id="good-moral-history-modal" class="row-border">
        ...
        <tbody>
          ...
          $goodmoralStatement->bindValue(':resident_id', $goodmoral['resident_id']);
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="./good-moral-view.php?good_moral_id=<?php echo $goodmoral['good_moral_id'] ?>">
              ...
              <td>
                <div class="table__action-buttons">
                  <a href="./good-moral-view.php?good_moral_id=<?php echo $goodmoral['good_moral_id'] ?>" class="button button--green button--sm action__cert" id="action-cert">
