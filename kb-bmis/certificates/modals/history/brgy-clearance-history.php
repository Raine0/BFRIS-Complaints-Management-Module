        ...
        <div class="modal__body">
            <table id="modal-table" class="row-border">
                ...
                <tbody>
                    ...
                    $clearanceStatement->bindValue(':resident_id', $clearance['resident_id']);
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="./brgy-clearance-view.php?brgy_clearance_id=<?php echo $clearance['brgy_clearance_id'] ?>">
                            ...
                            <td>
                                <div class="table__action-buttons">
                                    <a href="./brgy-clearance-view.php?brgy_clearance_id=<?php echo $clearance['brgy_clearance_id'] ?>" class="button button--green button--sm action__cert" id="action-cert">
